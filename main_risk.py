...
def models(data_all, i_glob, train_size, b, h, c, alpha, epsilon, lam_true, UB,loss_opt,z_opt,all_eps, val=False):
...
if __name__ == '__main__':
    ...
    output(b, h,c, alpha, data_all, num_ins, train_size, epsilon, lam_true, UB, loss_opt,z_opt,all_eps, val)
